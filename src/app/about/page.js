    ...
    return(
        ...
        <Navbar />
            <div className='flex justify-around flex-raw m-10 max-md:justify-center max-md:flex-col'>
                {/* <div className="pr-5 flex-1 max-md:flex justify-center max-md:justify-center max-md:flex-col max-md:items-center max-md:py-5"> */}
                <div className="pr-5 flex-1 flex items-center flex-col py-5">
                    ...
                    <div className="text-xl max-sm:text-lg">
                        ...
                        {/* <p><b>Email : </b>happyprajapati2010@gmail.com</p>
                        <p><b>Linked In : </b>Happy Prajapati</p> */}
                ...
                {/* <div> */}
                    ...
                    {/* </div> */}
                    {/* <div className="flex flex-raw justify-center  max-md:py-5 max-sm:hidden">
                    ...
                    {/* <div className="flex flex-raw justify-center  max-md:py-5 sm:hidden">
                        <div className="flex w-full gap-x-5 justify-center">
                            <Image className="rounded-xl" src={img1}
                            width={180}
                            height={180}
